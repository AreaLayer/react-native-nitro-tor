...
namespace margelo::nitro::nitrotor {
  ...
  //     : HybridObject(TAG) {}
  HybridTor::HybridTor() : HybridTorSpec() {}
  ...
  // double HybridTor::intoOwnedTorService(double servicePtr) { // Signature matches
  // HybridTorSpec.hpp
  //   TorService *servicePtrRaw = reinterpret_cast<TorService
  //   *>(static_cast<intptr_t>(servicePtr)); rustOwnedTorServicePtr =
  //   into_owned_tor_service(servicePtrRaw); rustTorServicePtr = nullptr;
  ...
  // void HybridTor::freeTorServiceInstance(double servicePtr) { // Signature matches
  // HybridTorSpec.hpp
  //   TorService *servicePtrRaw = reinterpret_cast<TorService
  //   *>(static_cast<intptr_t>(servicePtr)); if (servicePtrRaw != nullptr) {
  ...
  //     hiddenServicePtr = create_hidden_service(ownedServicePtrRaw, toPort_u16, hsPort_u16,
  //     nullptr);
  //   } else {
  //     hiddenServicePtr =
  //         create_hidden_service(ownedServicePtrRaw, toPort_u16, hsPort_u16,
  //         secretKeyBytes.data());
  //   }
  ...
  //                                const std::string &onion) { // Signature matches
  //                                HybridTorSpec.hpp
  //   OwnedTorService *ownedServicePtrRaw =
  //       reinterpret_cast<OwnedTorService *>(static_cast<intptr_t>(ownedServicePtr));
  //   if (ownedServicePtrRaw == nullptr) {

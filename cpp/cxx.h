...
#define CXXBRIDGE1_RUST_BOX
    ...
    template <typename T> const T *Box<T>::operator->() const noexcept { return this->ptr; }
...
#define CXXBRIDGE1_RUST_VEC
    ...
    template <typename T> bool Vec<T>::empty() const noexcept { return this->size() == 0; }
    ...
    template <typename T> void Vec<T>::push_back(const T &value) { this->emplace_back(value); }
    ...
    template <typename T> typename Vec<T>::const_iterator Vec<T>::begin() const noexcept {
      return this->cbegin();
    }

    template <typename T> typename Vec<T>::const_iterator Vec<T>::end() const noexcept {
      return this->cend();
    }

    template <typename T> typename Vec<T>::const_iterator Vec<T>::cbegin() const noexcept {
      return Slice<const T>(this->data(), this->size()).begin();
    }

    template <typename T> typename Vec<T>::const_iterator Vec<T>::cend() const noexcept {
